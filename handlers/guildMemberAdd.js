...
client.on("guildMemberAdd", function(member){
    client.channels.get("761076543341985812").send({embed:{
        color: 3066993,
        title: `**Bienvenido al discord de Holland Cargo**`,
        description: `Bienvenido ${member}`,
        thumbnail: {
            url: member.user.avatarURL || "https://media.discordapp.net/attachments/758548412244951062/761076086385541130/H2_1_copia.png?width=943&height=475"
        },
        fields: [
            {
                name: "Información",
                value: "Por favor leer nuestras <#758542086113984522>."
            },
            {
            ...
            },
            {
                ...
                value: "Por favor ve a <#758542185007415387> y adquiere tu rol."
            }
        ],
        footer: {
