...
client.on("ready", async () => {
        ...
        client.user.setActivity(`hollandcargovtc.com`, { type: 'Watching'})
        console.log(prefix);
        client.channels.get("761078103056318464").send(`El bot se a reiniciado para ${client.users.size} miembros, sin errores ni problemas.`);
